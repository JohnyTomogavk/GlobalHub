export const DASHBOARD_RESOURCE_NAME = 'dashboard';
export const BUDGET_RESOURCE_NAME = 'budgets';
...
export const ResourceToBreadCrumbsTitleMapping = {
  ...
  [TASK_RESOURCE_NAME]: 'Tasks',
  [BUDGET_RESOURCE_NAME]: 'Budgets',
  [NOTE_RESOURCE_NAME]: 'Notes',
